...
A classic Minesweeper game with a Mario theme, built in Rust using the egui GUI framework. Developed with the assistance of Gemini CLI and GitHub Copilot, this modern take on the iconic puzzle game features multiple difficulty levels, a dark theme, and an interactive desktop experience.
...
- **Classic Minesweeper Gameplay**
  - Left-click to reveal cells or chord (auto-reveal neighbors)
  - Right-click to flag/unflag suspected mines
  - Auto-reveal adjacent cells when all neighboring mines are flagged (Chording)
...
6. **Advanced (Chording)**: Once a numbered cell is revealed with all adjacent mines flagged, you can left-click it to auto-reveal all safe neighbors
...
- This project code was generated by Gemini CLI and GitHub Copilot.
